...
struct render_control
{
  ...
  [[nodiscard]] virtual bool is_stop_requested() const { return false; }
  [[nodiscard]] virtual bool is_pause_requested() const { return false; }
};
...
struct tile_grid
{
  ...
  [[nodiscard]] rect2i tile(size_t i) const
  {
