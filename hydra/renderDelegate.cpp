    ...
    HdRprimCollection const& collection)
{
    ...
    return HdRenderPassSharedPtr(new HdWeekendRenderPass(
...
HdInstancer* HdWeekendRenderDelegate::CreateInstancer(
...
static VtValue _ToClearValue(aov_descriptor const& d)
{
    ...
    case 3: return VtValue(GfVec3f(d.clear_value[0], d.clear_value[1],
                                   d.clear_value[2]));
    default: return VtValue(GfVec4f(d.clear_value[0], d.clear_value[1],
                                    d.clear_value[2], d.clear_value[3]));
    }
}
